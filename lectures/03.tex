...
However, for nested \lstinline{do ... while ...od} constructs the size of extended program is exponential w.r.t. the nesting depth, which makes the whole idea unreasonable.
