	.file "/home/alhasan/.opam/lama/Lama/HW/compilers-2021-spring/src/Stmt.lama"

	.stabs "/home/alhasan/.opam/lama/Lama/HW/compilers-2021-spring/src/Stmt.lama",100,0,0,.Ltext
...
# LINE (41) / 
	...
	.stabn 68,0,41,.L0-LevalStmt

.L0:

# LINE (42) / 

	.stabn 68,0,42,.L1-LevalStmt
...
# BEGIN ("Leval", 2, 3, [], ["c"; "stmt"], [{ blab="L16"; elab="L17"; names=[]; subs=[{ blab="L19"; elab="L20"; names=[]; subs=[{ blab="L145"; elab="L146"; names=[("s1", 1); ("e", 0)]; subs=[{ blab="L147"; elab="L148"; names=[("c2", 2)]; subs=[{ blab="L165"; elab="L166"; names=[]; subs=[]; }; { blab="L161"; elab="L162"; names=[]; subs=[]; }]; }]; }; { blab="L124"; elab="L125"; names=[("e", 1); ("s1", 0)]; subs=[{ blab="L126"; elab="L127"; names=[]; subs=[{ blab="L141"; elab="L142"; names=[]; subs=[]; }; { blab="L135"; elab="L136"; names=[]; subs=[]; }]; }]; }; { blab="L102"; elab="L103"; names=[("e", 2); ("s1", 1); ("s2", 0)]; subs=[{ blab="L104"; elab="L105"; names=[]; subs=[{ blab="L117"; elab="L118"; names=[]; subs=[]; }; { blab="L113"; elab="L114"; names=[]; subs=[]; }]; }]; }; { blab="L86"; elab="L87"; names=[("e", 0)]; subs=[{ blab="L88"; elab="L89"; names=[]; subs=[]; }]; }; { blab="L62"; elab="L63"; names=[("s", 0)]; subs=[{ blab="L64"; elab="L65"; names=[]; subs=[{ blab="L72"; elab="L73"; names=[("n", 2); ("w", 1)]; subs=[{ blab="L74"; elab="L75"; names=[]; subs=[]; }]; }]; }]; }; { blab="L55"; elab="L56"; names=[]; subs=[{ blab="L57"; elab="L58"; names=[]; subs=[]; }]; }; { blab="L44"; elab="L45"; names=[("s1", 1); ("s2", 0)]; subs=[{ blab="L46"; elab="L47"; names=[]; subs=[]; }]; }; { blab="L26"; elab="L27"; names=[("s", 1); ("e", 0)]; subs=[{ blab="L28"; elab="L29"; names=[]; subs=[]; }]; }]; }]; }]) / 
