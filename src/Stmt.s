	.file "/home/sedav/lama/compilers-supplementary/src/Stmt.lama"

	.stabs "/home/sedav/lama/compilers-supplementary/src/Stmt.lama",100,0,0,.Ltext
...
# BEGIN ("Leval", 2, 6, [], ["__tmp0"; "stmt"], [{ blab="L16"; elab="L17"; names=[]; subs=[{ blab="L23"; elab="L24"; names=[("c", 2); ("s", 1); ("w", 0)]; subs=[{ blab="L25"; elab="L26"; names=[]; subs=[{ blab="L86"; elab="L87"; names=[("e", 3)]; subs=[{ blab="L88"; elab="L89"; names=[]; subs=[]; }]; }; { blab="L65"; elab="L66"; names=[("x", 3)]; subs=[{ blab="L67"; elab="L68"; names=[]; subs=[{ blab="L74"; elab="L75"; names=[("n", 5); ("w", 4)]; subs=[{ blab="L76"; elab="L77"; names=[]; subs=[]; }]; }]; }]; }; { blab="L58"; elab="L59"; names=[]; subs=[{ blab="L60"; elab="L61"; names=[]; subs=[]; }]; }; { blab="L47"; elab="L48"; names=[("s1", 4); ("s2", 3)]; subs=[{ blab="L49"; elab="L50"; names=[]; subs=[]; }]; }; { blab="L32"; elab="L33"; names=[("x", 4); ("e", 3)]; subs=[{ blab="L34"; elab="L35"; names=[]; subs=[]; }]; }]; }]; }]; }]) / 
	...
	.stabn 192,0,0,L65-Leval

	.stabs "n:1",128,0,0,-24

	.stabs "w:1",128,0,0,-20

	.stabn 192,0,0,L74-Leval

	.stabn 224,0,0,L75-Leval

	.stabn 224,0,0,L66-Leval
