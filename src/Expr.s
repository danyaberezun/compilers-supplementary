	.file "/mnt/c/wok/PLC/compilers-supplementary/src/Expr.lama"

	.stabs "/mnt/c/wok/PLC/compilers-supplementary/src/Expr.lama",100,0,0,.Ltext
...
string_12:	.string	"Operator %s is not implemented\n"
...
# BEGIN ("LevalExpr", 2, 3, [], ["st"; "exp"], [{ blab="L4"; elab="L5"; names=[]; subs=[{ blab="L7"; elab="L8"; names=[]; subs=[{ blab="L29"; elab="L30"; names=[("op", 2); ("exp1", 1); ("exp2", 0)]; subs=[{ blab="L31"; elab="L32"; names=[]; subs=[]; }]; }; { blab="L23"; elab="L24"; names=[("i", 0)]; subs=[{ blab="L25"; elab="L26"; names=[]; subs=[]; }]; }; { blab="L14"; elab="L15"; names=[("s", 0)]; subs=[{ blab="L16"; elab="L17"; names=[]; subs=[]; }]; }]; }]; }]) / 
...
# BEGIN ("LevalBinop", 3, 0, [], ["op"; "exp1"; "exp2"], [{ blab="L40"; elab="L41"; names=[]; subs=[{ blab="L43"; elab="L44"; names=[]; subs=[{ blab="L124"; elab="L125"; names=[]; subs=[{ blab="L126"; elab="L127"; names=[]; subs=[]; }]; }; { blab="L118"; elab="L119"; names=[]; subs=[{ blab="L120"; elab="L121"; names=[]; subs=[]; }]; }; { blab="L111"; elab="L112"; names=[]; subs=[{ blab="L113"; elab="L114"; names=[]; subs=[]; }]; }; { blab="L104"; elab="L105"; names=[]; subs=[{ blab="L106"; elab="L107"; names=[]; subs=[]; }]; }; { blab="L97"; elab="L98"; names=[]; subs=[{ blab="L99"; elab="L100"; names=[]; subs=[]; }]; }; { blab="L90"; elab="L91"; names=[]; subs=[{ blab="L92"; elab="L93"; names=[]; subs=[]; }]; }; { blab="L83"; elab="L84"; names=[]; subs=[{ blab="L85"; elab="L86"; names=[]; subs=[]; }]; }; { blab="L76"; elab="L77"; names=[]; subs=[{ blab="L78"; elab="L79"; names=[]; subs=[]; }]; }; { blab="L69"; elab="L70"; names=[]; subs=[{ blab="L71"; elab="L72"; names=[]; subs=[]; }]; }; { blab="L62"; elab="L63"; names=[]; subs=[{ blab="L64"; elab="L65"; names=[]; subs=[]; }]; }; { blab="L55"; elab="L56"; names=[]; subs=[{ blab="L57"; elab="L58"; names=[]; subs=[]; }]; }; { blab="L48"; elab="L49"; names=[]; subs=[{ blab="L50"; elab="L51"; names=[]; subs=[]; }]; }]; }]; }]) / 
	...
	.stabs "exp1:p1",160,0,0,12

	.stabs "exp2:p1",160,0,0,16
...
# STRING ("Operator %s is not implemented\\n") / 
