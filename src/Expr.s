	.file "/mnt/c/Users/adnin/Documents/University/Compilers/compilers-2021-spring/src/Expr.lama"

	.stabs "/mnt/c/Users/adnin/Documents/University/Compilers/compilers-2021-spring/src/Expr.lama",100,0,0,.Ltext
...
# BEGIN ("LevalOp", 3, 0, [], ["op"; "v1"; "v2"], [{ blab="L4"; elab="L5"; names=[]; subs=[{ blab="L7"; elab="L8"; names=[]; subs=[{ blab="L95"; elab="L96"; names=[]; subs=[{ blab="L97"; elab="L98"; names=[]; subs=[]; }]; }; { blab="L89"; elab="L90"; names=[]; subs=[{ blab="L91"; elab="L92"; names=[]; subs=[]; }]; }; { blab="L82"; elab="L83"; names=[]; subs=[{ blab="L84"; elab="L85"; names=[]; subs=[]; }]; }; { blab="L75"; elab="L76"; names=[]; subs=[{ blab="L77"; elab="L78"; names=[]; subs=[]; }]; }; { blab="L68"; elab="L69"; names=[]; subs=[{ blab="L70"; elab="L71"; names=[]; subs=[]; }]; }; { blab="L61"; elab="L62"; names=[]; subs=[{ blab="L63"; elab="L64"; names=[]; subs=[]; }]; }; { blab="L54"; elab="L55"; names=[]; subs=[{ blab="L56"; elab="L57"; names=[]; subs=[]; }]; }; { blab="L47"; elab="L48"; names=[]; subs=[{ blab="L49"; elab="L50"; names=[]; subs=[]; }]; }; { blab="L40"; elab="L41"; names=[]; subs=[{ blab="L42"; elab="L43"; names=[]; subs=[]; }]; }; { blab="L33"; elab="L34"; names=[]; subs=[{ blab="L35"; elab="L36"; names=[]; subs=[]; }]; }; { blab="L26"; elab="L27"; names=[]; subs=[{ blab="L28"; elab="L29"; names=[]; subs=[]; }]; }; { blab="L19"; elab="L20"; names=[]; subs=[{ blab="L21"; elab="L22"; names=[]; subs=[]; }]; }; { blab="L12"; elab="L13"; names=[]; subs=[{ blab="L14"; elab="L15"; names=[]; subs=[]; }]; }]; }]; }]) / 
	...
	.stabs "v1:p1",160,0,0,12

	.stabs "v2:p1",160,0,0,16
...
# BEGIN ("LevalExpr", 2, 3, [], ["st"; "expr"], [{ blab="L101"; elab="L102"; names=[]; subs=[{ blab="L104"; elab="L105"; names=[]; subs=[{ blab="L126"; elab="L127"; names=[("op", 2); ("e1", 1); ("e2", 0)]; subs=[{ blab="L128"; elab="L129"; names=[]; subs=[]; }]; }; { blab="L120"; elab="L121"; names=[("n", 0)]; subs=[{ blab="L122"; elab="L123"; names=[]; subs=[]; }]; }; { blab="L111"; elab="L112"; names=[("v", 0)]; subs=[{ blab="L113"; elab="L114"; names=[]; subs=[]; }]; }]; }]; }]) / 
