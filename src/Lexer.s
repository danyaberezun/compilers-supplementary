	.file "/home/imhost/compilers-2021-spring-1/src/Lexer.lama"

	.stabs "/home/imhost/compilers-2021-spring-1/src/Lexer.lama",100,0,0,.Ltext
...
# BEGIN ("Llambda_0", 1, 0, [], ["k"], [{ blab="L196"; elab="L197"; names=[]; subs=[{ blab="L199"; elab="L200"; names=[]; subs=[]; }]; }]) / 
...
# BEGIN ("Llambda_1_3", 1, 2, [Arg (0)], ["s"], [{ blab="L201"; elab="L202"; names=[]; subs=[{ blab="L204"; elab="L205"; names=[]; subs=[{ blab="L232"; elab="L233"; names=[("a", 0)]; subs=[{ blab="L234"; elab="L235"; names=[]; subs=[]; }]; }; { blab="L215"; elab="L216"; names=[("a", 1); ("v", 0)]; subs=[{ blab="L217"; elab="L218"; names=[]; subs=[{ blab="L230"; elab="L231"; names=[]; subs=[]; }; { blab="L223"; elab="L224"; names=[]; subs=[]; }]; }]; }]; }]; }]) / 
	...
	.stabn 192,0,0,L232-Llambda_1_3

	.stabn 224,0,0,L233-Llambda_1_3

	.stabs "a:1",128,0,0,-8

	.stabs "v:1",128,0,0,-4

	.stabn 192,0,0,L215-Llambda_1_3

	.stabn 224,0,0,L216-Llambda_1_3
...
# BEGIN ("Ls", 1, 0, [], ["t"], [{ blab="L236"; elab="L237"; names=[]; subs=[{ blab="L239"; elab="L240"; names=[]; subs=[]; }]; }]) / 
...
# BEGIN ("LgetLoc", 1, 1, [], ["s"], [{ blab="L247"; elab="L248"; names=[]; subs=[{ blab="L250"; elab="L251"; names=[]; subs=[{ blab="L258"; elab="L259"; names=[("loc", 0)]; subs=[{ blab="L260"; elab="L261"; names=[]; subs=[]; }]; }]; }]; }]) / 
	...
	.stabn 192,0,0,L258-LgetLoc

	.stabn 224,0,0,L259-LgetLoc
...
# BEGIN ("Llocated", 1, 0, [], ["p"], [{ blab="L262"; elab="L263"; names=[]; subs=[{ blab="L265"; elab="L266"; names=[]; subs=[]; }]; }]) / 
...
# BEGIN ("Llambda_2_19", 1, 0, [Arg (0)], ["l"], [{ blab="L269"; elab="L270"; names=[]; subs=[{ blab="L272"; elab="L273"; names=[]; subs=[]; }]; }]) / 
...
# BEGIN ("Llambda_3_21", 1, 0, [Arg (0)], ["x"], [{ blab="L276"; elab="L277"; names=[]; subs=[{ blab="L279"; elab="L280"; names=[]; subs=[]; }]; }]) / 
